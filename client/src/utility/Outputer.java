...
public class Outputer {
     ...
     * @param arg   Args for output.
     */
    public static void printWarning(String toOut, String arg) {
        System.out.println("warning: " + tryResource(toOut, arg));
    }

    /**
     * Prints warning: toOut.toString() to Console
     *
     * @param toOut Warning to print
     */
    public static void printWarning(String toOut) {
        printWarning(toOut, null);
    }
